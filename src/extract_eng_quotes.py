...
#
# This script will take the tab separated English quotes
...
def main():
    ...
    for line in input_quotes:
        ...
        # and length of line says whether it was subjective
        if line[-1] == "TRUE":
            ...
            target_name = line[5]
            # 7th - 10th lines will be the annotated polarity
            annotated_polarity = [x for x in line[6:10] if x != '']
            if not annotated_polarity: # is objective
                obj_quotes.append((id,quote,source_name,target_name))
            else:
                if len(annotated_polarity) != 2:
                    sys.stderr.write("Warning: Incorrect number of annotators.\n")
                elif annotated_polarity[0] != annotated_polarity[1]:
                ...
                if polarity == "POS":
                    ...
                    sys.stderr.write("Warning: Polarity other than POS or NEG\n")
